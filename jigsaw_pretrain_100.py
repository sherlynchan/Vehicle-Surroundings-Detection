...
if __name__ == '__main__':
    ...
    permutation_list = random.sample(l,100)
    #print('hi')
    ...
    for ep in range(epoch):
        ...
        torch.save(model_ae.encoder.state_dict(), "models_pkl/200_resencoder_bbox_segment_epoch" + str(ep + 1) + ".pkl")
        torch.save(optimizer_ae.state_dict(), "models_pkl/200_resencoder_bbox_segment_optimizer_epoch" + str(ep + 1) + ".pkl")
